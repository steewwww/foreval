                            ...
                            <tbody>
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td>
                                                    <button class="btn btn-success editbtn rounded-pill shadow-sm mb-3" data-toggle="modal" data-target="#updateModal" data-id="<?php echo $row['id']; ?>">
                                                        <i class="fas fa-edit mr-1"></i>Update
                                                    </button>

                                                    <button class="btn btn-danger deletebtn rounded-pill shadow-sm mb-3" data-toggle="modal" data-target="#deleteModal" data-id="<?php echo $row['id']; ?>">

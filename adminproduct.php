...
<div class="container mt-5">
        <div class="row justify-content-center">
            <div class="col-lg-12 px-20" id="order"> <!-- Adjusted the width to col-lg-12 -->
                <div class="card">
                    <div class="card-body">
                        <header>
                        ...
                        <div>
                        <button class="btn btn-success btn-lg rounded-pill shadow-sm mb-3" data-toggle="modal" data-target="#addModal">
                            ...
                            ?>
                                <tr>
                                    ...
                                    <div class="form-group">
                                        <div class="row">
                                            <div class="col">
                                                <button class="btn btn-success editbtn" data-toggle="modal" data-target="#updateModal" data-id="<?php echo $row['id']; ?>">
                                                    <i class="fas fa-edit mr-1"></i>Update
                                                </button>
                                            </div>
                                            <div class="col">
                                                <button class="btn btn-danger deletebtn" data-toggle="modal" data-target="#deleteModal" data-id="<?php echo $row['id']; ?>">
            ...
            <div class="modal-body">
                <form id="addProductForm">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="productPrice" class="form-control" name="product_price" required>
                    </div>
                    <div class="form-group">
        ...
        <div class="modal-content">
            ...
            <form action="updateproduct.php" method="POST">
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" name="update_product" class="btn btn-success">Update Data</button>
                </div>
            </form>
        </div>
    </div>
...
<script>
    var cleave = new Cleave('#productPrice', {
        numeral: true,
    ...
    $('#addProductForm').submit(function(event) {
        ...
        $.ajax({
            ...
            success: function(response) {
                // Check response from addproduct.php
                if (response === 'success') {
                    ...
                    $('#addModal .modal-body').prepend('<div class="alert alert-danger" role="alert">Barcode already exists.</div>');
                }
            },
            error: function(xhr, status, error) {
                // Display error message
                $('#addModal .modal-body').prepend('<div class="alert alert-danger" role="alert">Error: ' + error + '</div>');
            }
        });
    });
});
